                            ...
                            <form id="check-out-form" action="{{ route('web.order.build') }}" method="post">
                                ...
                                <div class="product-content">
                                    ...
                                    <div class="quantity">
                                        ...
                                        <div class="qty">
                                            <button type="button" class="btn-minus button-quantity"><i class="fa fa-minus"></i>
                                            </button>
                                            <input id="amount" type="text" name="items[{{ $product->id ?? 0 }}][product_quantity]" value="1">
                                            <button type="button" class="btn-plus button-quantity"><i class="fa fa-plus"></i>
                                            </button>
                                        </div>
                                    ...
                                    <div class="p-color">
                                        <div class="input-append" style="display: flex;">
                                            ...
                                            <select id="color" name="items[{{ $product->id ?? 0 }}][color]" style="width: 50%;" class="form-control input-sm">
                                ...
                                <input type="hidden" name="items[{{ $product->id ?? 0 }}][product_id]" value="{{ $product->id ?? 0 }}">
                                <input type="hidden" name="items[{{ $product->id ?? 0 }}][product_name]" value="{{ $product->name ?? '' }}">
                                <input type="hidden" name="items[{{ $product->id ?? 0 }}][product_price]" value="{{ $product->price ?? 0 }}">
                                <input type="hidden" name="items[{{ $product->id ?? 0 }}][product_image]" value="{{ $product->image_url ?? '' }}">
                                <div class="col-lg-12">
                                    <div class="checkout-inner">
                                        <div class="billing-address">
                                            ...
                                            <div class="row">
                                                ...
                                                <div class="col-md-12">
                                                    <button type="submit" class="btn"><i class="fa fa-shopping-cart"></i> @lang('languages.place_order')
                                                    </button>
                                                </div>
                                                &emsp;
                                            </div>
