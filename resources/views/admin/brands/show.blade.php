                                        ...
                                        <tr>
                                            ...
                                            <td style="text-align: center;">
                                                ...
                                                <a class="btn btn-success"
                                                   href="{{ route('editBrand', $brandData->id) }}"><i
                                                        class="bi bi-pencil-square"></i></a> &emsp;
